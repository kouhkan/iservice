...
def number_validator(password):
    ...
    if regex.search(password) == None:
        raise ValidationError(_("password must include number"),
...
def letter_validator(password):
    ...
    if regex.search(password) is None:
        raise ValidationError(_("password must include letter"),
...
def special_char_validator(password):
    ...
    if regex.search(password) == None:
        raise ValidationError(_("password must include special char"),
