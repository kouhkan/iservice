...
class Order(BaseModel):
    ...
    for_other = models.ForeignKey(get_user_model(),
                                  on_delete=models.CASCADE,
                                  related_name="orders",
                                  null=True,
                                  blank=True)
    discount = models.ForeignKey("discounts.Discount",
                                 ...
                                 null=True,
                                 blank=True)
    expert = models.ForeignKey("experts.Expert",
    ...
    order_track_id = models.CharField(max_length=10,
                                      default=generate_track_token,
                                      unique=True,
                                      db_index=True,
                                      null=True,
                                      blank=True)
    ...
    user_address = models.ForeignKey("users.Address",
                                     on_delete=models.PROTECT,
                                     related_name="orders",
                                     null=True,
                                     blank=True)
